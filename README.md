...
:warning: Do not execute _any_ API method which will require accessing location-services until the callback to \*_`#ready_`executes (eg:`#getCurrentPosition`,`#watchPosition`,`#start`).
